...
fun CurrencyScreen(navController: NavController) {
    Scaffold(topBar = { TopBar(navController, stringResource(id = R.string.currency)) }) { innerPadding ->
        ...
        LazyColumn(
            ...
            items(currencies.size) { index ->
                CurrencyButton(text = stringResource(id = currencies[index]))
            }
        }
    }
}
...
@Composable
private fun CurrencyButton(text: String) {
    Button(
