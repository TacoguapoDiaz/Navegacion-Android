    ...
    Scaffold(
        ...
        if (hasContent) {
            LazyColumn(
                ...
                item {
                    // Reutilizamos la tarjeta de auto, pero la adaptamos
                    CarListItem(
                        imageRes = R.drawable.mazda_blue, // Necesitas esta imagen
                        carName = "Mazda 2025",
                        rating = 4.5,
                        isFavorite = true
                    )
                ...
                item {
                    CarListItem(
                        imageRes = R.drawable.nissan_versa_blue, // Necesitas esta imagen
                        carName = "Versa 2024",
                        rating = 4.0,
                        isFavorite = true
                    )
